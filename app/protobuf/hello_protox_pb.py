...
class CodeGeneratorRequest(protox.Message):
    ...
    proto_file: typing.List[protox.FileDescriptorProto]
    compiler_version: typing.Optional['google.protobuf.compiler.Version']
    ...
    def __init__(
        ...
        *,
        ...
        proto_file: typing.List[protox.FileDescriptorProto] = None,
        compiler_version: typing.Optional['google.protobuf.compiler.Version'] = None,
    ):
        super().__init__(
...
class CodeGeneratorResponse(protox.Message):
    ...
    file: typing.List['google.protobuf.compiler.CodeGeneratorResponse.File']

    def __init__(
        self,
        *,
        error: typing.Optional[str] = None,
        file: typing.List['google.protobuf.compiler.CodeGeneratorResponse.File'] = None,
    ):
        super().__init__(
            error=error,
            file=file,
...
protox.define_fields(
    ...
    proto_file=protox.FileDescriptorProto.as_repeated(
        number=15
    ),
    compiler_version=google.protobuf.compiler.Version.as_field(
        number=3, required=False
    ),
)
...
protox.define_fields(
    ...
    file=google.protobuf.compiler.CodeGeneratorResponse.File.as_repeated(
        number=15
    ),
)
